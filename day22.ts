...
function Combine(text:string,num:number){
    return text + num
}
console.log(Combine("Age:",20));
...
function checkTwoBoolean(value1:boolean,value2:boolean){
    return value1 && value2
}
console.log(checkTwoBoolean(true,false));
